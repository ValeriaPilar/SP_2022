...
reporte_SP_2022_efectores <- merge(x=reporte_TV_efectores, y=reporte_P_efectores, by="efector", all.x= TRUE)


library(DT)
datatable(reporte_SP_2022_efectores,  class = 'cell-border', rownames = head(NULL), colnames = c('Efector', 'Registros Triple Viral', "Registros Polio"), options = list(
  order = list(1, 'desc'),
...
Vacunas aplicadas APS {data-icon="fa-table" data-orientation=rows}
===================================== 

Inputs
--------------------------------------------------

### **Vacunas aplicadas APS** {data-width=50}
...
personas_vacunadas <- personas_vacunadas[, c(1,2,20:27)] 

datatable(personas_vacunadas,  class = 'cell-border', rownames = head(NULL), colnames = c("Efector",	"Vacuna",	"2022-10-19","2022-10-20","2022-10-21","2022-10-22","2022-10-23","2022-10-24","2022-10-25","Total"),
          options = list(
  order = list(4, 'desc'), 
  columnDefs = list(list()),
  pageLength = 100,
